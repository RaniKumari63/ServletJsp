package com.suchiit.ServletFilter;
...
/**
 * Servlet Filter implementation class RegistrationFilter1
 */
public class RegistrationFilter1 extends HttpFilter implements Filter {
	String eid_err_msg="",ename_err_msg="",
			eage_err_msg="",
			eemail_err_msg="",
			emobile_err_msg="";
   boolean b=true; 
